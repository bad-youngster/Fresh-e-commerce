...
class GoodsGeategory(models.Model):
    '''
    商品分类
    '''
    CATEGORY_TYPE = (
    ...
    desc = models.CharField(default="",max_length=50,verbose_name="类别描述",help_text="类别描述")
    category_type = models.CharField(max_length=50,choices=CATEGORY_TYPE,verbose_name="类目级别",help_text="类目级别")
...
class GoodCategoryBrand(models.Model):
    ...
    品牌名
    '''
    category = models.ForeignKey(GoodsGeategory, null=True, blank=True, verbose_name="商品类目", on_delete=models.CASCADE,)
...
class IndexAd(models.Model):
    ...
    商品类别广告
    '''
    category = models.ForeignKey(GoodsGeategory,related_name='category',verbose_name="商品类目",on_delete=models.CASCADE,)
    goods = models.ForeignKey(Goods,related_name='good',on_delete=models.CASCADE,)
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
    class Meta:
        verbose_name = "商品类别广告"
        verbose_name_plural = verbose_name
