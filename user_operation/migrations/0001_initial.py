    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('singer_moblie', models.CharField(default='', max_length=11, verbose_name='电话')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('msg_type', models.IntegerField(choices=[(1, '留言'), (2, '投诉'), (3, '询问'), (4, '售后'), (5, '求购')], default=1, help_text='留言类型:1(留言),2(投诉),3询问),4(售后),5(求购)', verbose_name='留言类型:1(留言),2(投诉),3询问),4(售后),5(求购)')),
