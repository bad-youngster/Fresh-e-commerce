...
class UserLeavingMesage(models.Model):
    ...
    user = models.ForeignKey(User, verbose_name=u"用户",on_delete=models.CASCADE,)
    msg_type = models.IntegerField(default=1,choices=MESSAGE_CHOICES,verbose_name="留言类型:1(留言),2(投诉),3询问),4(售后),5(求购)",
                                   help_text=u"留言类型:1(留言),2(投诉),3询问),4(售后),5(求购)")
...
class UserAddress(models.Model):
    ...
    singer_moblie = models.CharField(max_length=11,default="",verbose_name="电话")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
